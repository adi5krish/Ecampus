# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-15 10:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Semester',
            fields=[
                ('semesterNo', models.IntegerField(default='', primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.AlterUniqueTogether(
            name='result',
            unique_together=set([('semesterNo', 'studentId')]),
        ),
        migrations.AlterUniqueTogether(
            name='registers',
            unique_together=set([('semesterNo', 'courseNo', 'studentId')]),
        ),
        migrations.AlterUniqueTogether(
            name='feereceipt',
            unique_together=set([('semesterNo', 'studentId')]),
